...
class Tool : public Item{
	public:
           Tool();
           Tool(char icon, string type, string name, int energy, int cost, string obstacle_type);
           Tool(const Item & item, string name, int energy, int cost, string obstacle_type);
	...
	private:
           ...
           int cost;
           int rating;
           string obstacle_type;  // obstacle type the tool matches to, so if the tool is a hammer, 
                                  // the matching obstacle is 'boulder'
};
